...
1. **[新規作成]** を選択し、**[プロンプト]** を選択します。 プロンプト ビルダー UI に移動します。
...
1. エージェントの概要ページの **[ツール]** セクションから、`Contoso Marketing Pitch` ツールを選択します。 ツールのプロパティと設定を構成するページに移動します。
1. プロンプト ツールの上部のナビゲーションで **[入力]** を選択します。
1. **[追加入力]** で **[追加]** を選択します。
...
## (省略可能) Copilot Studio でプロンプト ツールをテストする

次に、Copilot Studio のプロンプト ツールを使用してエージェントをテストします。
...
1. 応答を見て、カスタム プロンプトの指示で指定したガイダンスにエージェントが従っているかどうかを確認します。

以上で演習を完了し、プロンプト ツールの機能を検証しました。
