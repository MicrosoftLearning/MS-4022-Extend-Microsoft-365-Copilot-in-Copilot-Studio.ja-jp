...
1. Web ブラウザーで、コースの [GitHub リポジトリ](https://github.com/MicrosoftLearning/MS-4022-Extend-Microsoft-365-Copilot-in-Copilot-Studio/blob/master/Allfiles/Products.zip) (`https://github.com/MicrosoftLearning/MS-4022-Extend-Microsoft-365-Copilot-in-Copilot-Studio/blob/master/Allfiles/Products.zip`) に移動します。
...
> [!NOTE]
> Copilot Studio エージェントが、ユーザーの代わりにドキュメントにアクセスします。 エージェントは、エンド ユーザーがアクセスできるドキュメントからの回答とコンテンツのみを取得できます。
